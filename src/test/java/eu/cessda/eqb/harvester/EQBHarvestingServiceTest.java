...
class EQBHarvestingServiceTest {
    private static final Repo testRepository = new Repo(
            Collections.singleton(new Repo.MetadataFormat(null, "oai_ddi", "DDI_2_5",
    ...
    void indexAllTest(@TempDir Path tempDir) throws IOException {
        ...
        var pipeline = new ObjectMapper().readValue(new File(tempDir + "/wrapped/TEST/oai_ddi/pipeline.json"),
