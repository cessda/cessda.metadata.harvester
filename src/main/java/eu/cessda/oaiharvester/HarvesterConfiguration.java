 ...
 *          &amp;metadataPrefix=oai_dc&amp;set=39
 *     setName: 'da|ra: ICPSR – Interuniversity Consortium
 *              for Political and Social Research'
 *     dataProvider: da|ra (Registration agency for social science and
 *                   economic data)
 * </pre>
 *
 * @author kraemets
...
class HarvesterConfiguration {
    ...
    public boolean equals(Object o) {
        ...
        return keepOAIEnvelope == that.keepOAIEnvelope
            && removeOAIEnvelope == that.removeOAIEnvelope
            && incremental == that.incremental
            && timeout == that.timeout
            && Objects.equals(dir, that.dir)
            && Objects.equals(repos, that.repos)
            && Objects.equals(from, that.from);
    }

    @Override
    public int hashCode() {
        return Objects.hash(dir, keepOAIEnvelope, removeOAIEnvelope,
                            incremental, repos, from, timeout);
    }
