...
public final class ListRecords extends HarvesterVerb implements Resumable {
    ...
    public static ListRecords instance(HttpClient httpClient, URI baseURL, String resumptionToken)
    ...
    public static ListRecords instance(HttpClient httpClient, URI baseURL, LocalDate from, LocalDate until, String set,
