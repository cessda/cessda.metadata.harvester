...
public interface Resumable {
     ...
     *
     * @return the oai:resumptionToken value, or an empty optional if
     *     a resumption token is not present
     */
    default Optional<String> getResumptionToken() {
        var resumptionToken = getDocument().getElementsByTagNameNS(
            OAI_2_0_NAMESPACE, "resumptionToken");
