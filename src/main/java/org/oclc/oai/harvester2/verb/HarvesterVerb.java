...
class HarvesterVerb
permits GetRecord, Identify, ListIdentifiers, ListMetadataFormats, ListRecords, ListSets
{
    ...
    /**
     * A formatter that supports all the date formats returned by OAI-PMH
     * repositories.
     */
        ...
        for (int i = 0; i < childNodes.getLength(); i++) {
            ...
            switch (node.getNodeName()) {
                ...
                case "datestamp" -> {
                    ...
                    datestamp = OAI_DATE_TIME_FORMATTER.parseBest(datestampString, OffsetDateTime::from,
