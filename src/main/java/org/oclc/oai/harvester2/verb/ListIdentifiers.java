...
/**
 * This class represents an ListIdentifiers response on either the
...
public final class ListIdentifiers extends HarvesterVerb implements Resumable {
    ...
    /**
     * Construct a new instance of {@link ListIdentifiers} using a
     * resumption token.
     *
     ...
     */
    public static ListIdentifiers instance(HttpClient httpClient, URI baseURL,
                                           String resumptionToken)
            throws IOException, SAXException {
        Objects.requireNonNull(resumptionToken,
                               "resumptionToken cannot be null");
     ...
     *
     * @param baseURL the URL of the repository.
     * @param from the date to harvest from. Set to {@code null} to
    ...
    /**
     * Returns a list of identifiers found in the response. The
     * returned list is unmodifiable.
     *
     * @throws java.time.format.DateTimeParseException if the datestamp
     *     element is not valid.
     */
    public List<RecordHeader> getIdentifiers() {
        var recordHeaders = getDocument().getElementsByTagNameNS(
            OAI_2_0_NAMESPACE, "header");
