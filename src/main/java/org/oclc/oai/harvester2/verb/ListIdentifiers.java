...
public final class ListIdentifiers extends HarvesterVerb implements Resumable {
     ...
     */
    public static ListIdentifiers instance(HttpClient httpClient, URI baseURL, String resumptionToken)
     ...
     * @param until          to date to harvest to. Set to {@code null} for no
     *                       limit.
     ...
     * @throws SAXException if an error occurs when parsing the XML.
     */
    public static ListIdentifiers instance(HttpClient httpClient, URI baseURL, LocalDate from, LocalDate until,
    ...
    /**
     * Returns a list of identifiers found in the response. The returned list is
     * unmodifiable.
     *
     * @throws java.time.format.DateTimeParseException if the datestamp element is
     *                                                 not valid.
     */
